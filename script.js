...
/**To resize the grid to a given dimension with the upper limit being 100(and grid is of dimension 100*100)*/
function changeGrid() {
    let num = prompt("Enter a number between 0(exclusive) and 200(inclusive)", "");
    num = Number(num);
    if (num <= 200 && num != null) {
        removeGrid();
        createGrid(num);
...
/**A random color generated by organising random integer values
 * in the rgb format
 */
